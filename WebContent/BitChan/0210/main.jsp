	      	...
	      	<tr>
	       	...
	       	<tr>
	          	<td colspan="3" bgcolor="<%=title_c%>"   align="center">
	            	...
	            	<input type="button"  value="비밀번호 찾기" onclick="javascript:window.location='findPwForm.jsp'">
	          	</td>
	         </tr>
	    </table>
    </form>
    	...
    	<tr>
            ...
            <td rowspan="3" bgcolor="<%=value_c%>" align="center">
             	...
             	<form method="post" action="logout.jsp"> 
             		...
             		<input type="button" value="비밀번호변경" onclick="javascript:window.location='modify_pw.jsp'">
             	</form>
         	</td>
        </tr>
       	<tr>
