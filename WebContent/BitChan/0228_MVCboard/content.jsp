...
<table width="500" border="1" cellspacing="0" cellpadding="0" align="center"> 
  ...
  <input type="button" value="글수정"
       onclick="document.location.href='/JSP_study/BitChan/0228_MVCboard/updateForm.do?num=${article.num}&pageNum=${pageNum}'">
   &nbsp;&nbsp;&nbsp;&nbsp;
  <input type="button" value="글삭제"
       onclick="document.location.href='/JSP_study/BitChan/0228_MVCboard/deleteForm.do?num=${article.num}&pageNum=${pageNum}'">
   &nbsp;&nbsp;&nbsp;&nbsp;
      <input type="button" value="답글쓰기"
       onclick="document.location.href='/JSP_study/BitChan/0228_MVCboard/writeForm.do?num=${article.num}&ref=${article.ref}&re_step=${article.re_step}&re_level=${article.re_level}'">
   &nbsp;&nbsp;&nbsp;&nbsp;
       <input type="button" value="글목록"
       onclick="document.location.href='/JSP_study/BitChan/0228_MVCboard/list.do?pageNum=${pageNum}'">
    </td>
  </tr>
</table>   
</form>     
